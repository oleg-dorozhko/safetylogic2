...
public class MyThread11 implements Runnable {
	...
	public MyThread11(GameModel model, MdfBufferStorage mbs,  Cell c1) throws Exception {
		this.model = model;
...
//	}
	...
	public MyThread11(GameModel gameModel, MdfBufferStorage mbs2, Cell c1, Cell c2) {
...
//	}
	 ...
	 public void run()
     {
		 try
		 {
			...
			clone_cells = exchangeTipaColors(clone_cells, this.cell,this.cell2);
