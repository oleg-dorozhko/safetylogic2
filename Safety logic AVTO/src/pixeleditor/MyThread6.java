...
public class MyThread6 implements Runnable {
	...
	public MyThread6(GameModel model, MdfBufferStorage mbs,  Cell c1, Cell c2) throws Exception {
		this.model = model;
	...
	public MyThread6(GameModel model,  Cell c1, Cell c2) throws Exception {
		this.model = model;
		this.cells = model.cells;
		this.cell = new Cell(c1);
		this.cell2 = new Cell(c2);
