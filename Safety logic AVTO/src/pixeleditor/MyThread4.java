...
public class MyThread4 implements Runnable {
	...
	public MyThread4(GameModel model, MdfBufferStorage mbs,  Cell c1, Cell c2) throws Exception {
		this.model = model;
	...
	public MyThread4(GameModel model,  Cell c1, Cell c2) throws Exception {
		this.model = model;
		this.cells = model.cells;
		this.cell = new Cell(c1);
		this.cell2 = new Cell(c2);
